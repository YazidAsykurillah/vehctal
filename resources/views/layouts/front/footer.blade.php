...
<footer class="footer">
    <div class="container">
        <div class="row">
            <div class="col-md-3  col-sm-3 col-xs-6">
                <div class="footer-logo">
                    <div class="footer-logo-text">{{ config('app.name') }}</div>
                    <p>Rent vehicles made easy</p>
                </div>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-6">
                <h3>Pages</h3>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="copyright">
                    <p class="pull-left" >&copy;Designed By <a href="http://scripteden.com">Scripteden</a> 2016</p>
